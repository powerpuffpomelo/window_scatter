...
def scatter(data, author_num, type_num, bgm_num):
    l = 0
    r = 0
...
data = scatter(data, author_num, type_num, bgm_num)
...
for t in range(experiment_times):
    data = generate_data(data_size, author_num, type_num, bgm_num)
    data, author_fail_num, type_fail_num, bgm_fail_num = scatter(data, author_num, type_num, bgm_num)
